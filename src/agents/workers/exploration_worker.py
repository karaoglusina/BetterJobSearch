...
Strategy:
1. For market overview questions, use aspect_distribution to show landscape
2. For "what kinds of X" questions, use cluster_by_aspect or cluster_by_concept
3. For browsing, use browse_cluster to show examples
4. Combine multiple tools to build a comprehensive picture
5. Summarize patterns and insights, not just raw data
...
class ExplorationWorker:
    ...
    def __init__(self, registry: ToolRegistry, *, model: str = "gpt-4o-mini"):
        ...
        self.model = model
        self.tool_names = [
            "cluster_by_aspect", "browse_cluster", "cluster_by_concept",
